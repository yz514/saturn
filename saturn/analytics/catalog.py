...
_DEFS: list[MetricDef] = [
    ...
    _d("reverse_dcf_fair_value_per_share", "Forward / Expectations", "per_share", "2-stage DCF(our growth, r=10%) / diluted shares", "Mid-case reverse-DCF fair value per share.", "Our growth = trailing 3-yr FCF CAGR clamped to [2.5%, 25%]; FCFE-style. Divides by diluted weighted-average shares; for the headline cheap/expensive read use margin_of_safety (total equity vs market cap), which can differ slightly since market cap reflects current shares outstanding."),
    ...
    _d("margin_of_safety", "Forward / Expectations", "percent", "reverse_dcf_fair_value (mid) / market_cap - 1", "Model fair value vs price (>0 = cheap vs model).", "The headline cheap/expensive read: total mid-case equity value vs market cap (no share count). May differ a little from per-share fair value vs price, which divides by diluted weighted-average shares while market cap reflects current shares."),
]
